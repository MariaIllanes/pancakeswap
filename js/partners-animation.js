export const partnersAnimationDocComponent = () => {
    const newElement = document.createElement('section');

    newElement.className = "partners-animation-container theme-change light-theme";
    newElement.innerHTML = `
    <section class="partners-animation">
    <div class="line-one theme-change light-theme show"></div>
    <div class="part-one-container">
      <div class="part-one show light-theme theme-change">
        <div class="line-two theme-change light-theme"></div>
        <div class="title-one theme-change light-theme">Ecosystem</div>
        <div class="content-container-one">
          <div
            class="content-subcontainer-one content-subcontainer-one-style"
            style="
          ...
          >
            <div
              ...
              "
            >
              <div class="carousel-child-container vertical-one">
                <div class="child" style="--transform: rotate(90deg)">
                  <div class="bYcBXK light-theme theme-change child-svg-container">
                    <svg
                      viewBox="0 0 24 24"
                      color="#7645d9"
                      width="20px"
                    ...
                    <div class="child-svg-text theme-change light-theme">Staking</div>
                  </div>
                </div>

                <div class="child" style="--transform: rotate(90deg)">
                  <div class="cFQsTH light-theme theme-change child-svg-container">
                    <svg
                      viewBox="0 0 24 24"
                      color="#7645d9"
                      width="20px"
                    ...
                    <div class="child-svg-text theme-change light-theme">Farming</div>
                  </div>
                </div>

                <div class="child" style="--transform: rotate(90deg)">
                  <div class="child-svg-container light-theme theme-change UzbBi">
                    <svg
                      viewBox="0 0 24 24"
                      color="#7645d9"
                      width="20px"
                    ...
                    <div class="child-svg-text theme-change light-theme">Trade</div>
                  </div>
                </div>

                <div class="child" style="--transform: rotate(90deg)">
                  <div class="child-svg-container light-theme theme-change cWcfGd">
                    <svg
                      viewBox="0 0 24 24"
                      color="#7645d9"
                      width="20px"
                    ...
                    <div class="child-svg-text theme-change light-theme">NFT</div>
                  </div>
                </div>

                <div class="child" style="--transform: rotate(90deg)">
                  <div class="child-svg-container light-theme theme-change VpIwQ">
                    <svg
                      viewBox="0 0 24 24"
                      color="#7645d9"
                      width="20px"
                    ...
                    <div class="child-svg-text theme-change light-theme">Liquidity Provision</div>
                  </div>
                </div>

                <div class="child" style="--transform: rotate(90deg)">
                  <div class="child-svg-container light-theme theme-change hYRNmJ">
                    <svg
                      viewBox="0 0 19 17"
                      color="#7645d9"
                      width="20px"
                    ...
                    <div class="child-svg-text theme-change light-theme">Game</div>
                  </div>
                </div>

                <div class="child" style="--transform: rotate(90deg)">
                  <div class="child-svg-container light-theme theme-change SSZbf">
                    <svg
                      viewBox="0 0 25 24"
                      color="#7645d9"
                      width="20px"
                    ...
                    <div class="child-svg-text theme-change light-theme">Governance</div>
                  </div>
                </div>

                <div class="child" style="--transform: rotate(90deg)">
                  <div class="child-svg-container light-theme theme-change jBBscj">
                    <svg
                      viewBox="0 0 21 18"
                      color="#7645d9"
                      width="20px"
                    ...
                    <div class="child-svg-text theme-change light-theme">IFO</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <div class="child" style="--transform: rotate(90deg)">
                <div class="child-svg-container bYcBXK theme-change light-theme">
                  <svg
                    viewBox="0 0 24 24"
                    color="#7645d9"
                    width="20px"
                  ...
                  <div class="child-svg-text-two theme-change light-theme">Staking</div>
                </div>
              </div>

              <div class="child" style="--transform: rotate(90deg)">
                <div class="child-svg-container light-theme theme-change cFQsTH">
                  <svg
                    viewBox="0 0 24 24"
                    color="#7645d9"
                    width="20px"
                  ...
                  <div class="child-svg-text-two theme-change light-theme">Farming</div>
                </div>
              </div>
              ...
              <div class="child" style="--transform: rotate(90deg)">
                <div class="child-svg-container light-theme theme-change UzbBi">
                  ...
                  <div class="child-svg-text-two theme-change light-theme">Trade</div>
                </div>
              </div>
              ...
              <div class="child" style="--transform: rotate(90deg)">
                <div class="child-svg-container light-theme theme-change cWcfGd">
                  ...
                  <div class="child-svg-text-two theme-change light-theme">NFT</div>
                </div>
              </div>
              ...
              <div class="child" style="--transform: rotate(90deg)">
                <div class="child-svg-container light-theme theme-change VpIwQ">
                  ...
                  <div class="child-svg-text-two theme-change light-theme">Liquidity Provision</div>
                </div>
              </div>
              ...
              <div class="child" style="--transform: rotate(90deg)">
                <div class="child-svg-container light-theme theme-change hYRNmJ">
                  ...
                  <div class="child-svg-text-two theme-change light-theme">Game</div>
                </div>
              </div>
              ...
              <div class="child" style="--transform: rotate(90deg)">
                <div class="child-svg-container light-theme theme-change SSZbf">
                  ...
                  <div class="child-svg-text-two theme-change light-theme">Governance</div>
                </div>
              </div>
              ...
              <div class="child" style="--transform: rotate(90deg)">
                <div class="child-svg-container light-theme theme-change jBBscj">
                  ...
                  <div class="child-svg-text-two theme-change light-theme">IFO</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="part-two-container theme-change light-theme">
      <div class="gvX">
        <canvas id="miCanvas" class="giC" width="900" height="900"></canvas>
      </div>
    </div>
    <div class="part-three-container">
      <div class="cFP theme-change light-theme show">
        <div class="jtD theme-change light-theme"></div>
        <div class="sc-hc eaF theme-change light-theme"></div>
        <div class="lbG theme-change light-theme">Partners</div>
        <div class="eRZ">
          <div
            class="marquee-container theme-change light-theme fMr"
            style="
              --pause-on-hover: running;
              --pause-on-click: running;
              --width: 100vh;
          ...
          >
            <div
              ...
              "
            >
              <div class="carousel-child-container">
                <div class="child" style="--transform: rotate(90deg)">
                  <div class="child-svg-container light-theme theme-change hRpYnQ">
                    <svg
                      viewBox="0 0 21 20"
                      color="black"
                      width="21"
                      xmlns="http://www.w3.org/2000/svg"
                      class="sc-bc gVLn theme-change light-theme"
                    >
                      <path
                    ...
                    <div class="child-svg-text theme-change light-theme">Ledger</div>
                  </div>
                </div>

                <div class="child" style="--transform: rotate(90deg)">
                  <div class="child-svg-container light-theme theme-change jkNBxj">
                    <svg
                      viewBox="0 0 22 20"
                      color="black"
                      width="20"
                    ...
                    <div class="child-svg-text theme-change light-theme">Metamask</div>
                  </div>
                </div>

                <div class="child" style="--transform: rotate(90deg)">
                  <div class="child-svg-container light-theme theme-change enBcKL">
                    <svg
                      viewBox="0 0 20 20"
                      color="black"
                      width="20"
                    ...
                    <div class="child-svg-text theme-change light-theme">Venus</div>
                  </div>
                </div>

                <div class="child" style="--transform: rotate(90deg)">
                  <div class="child-svg-container light-theme theme-change ieACox">
                    <svg
                      viewBox="0 0 20 24"
                      color="black"
                      width="20"
                    ...
                    <div class="child-svg-text theme-change light-theme">Alpaca Finance</div>
                  </div>
                </div>

                <div class="child" style="--transform: rotate(90deg)">
                  <div class="child-svg-container light-theme theme-change gDeGgY">
                    <svg
                      viewBox="0 0 20 20"
                      color="black"
                      width="20"
                    ...
                    <div class="child-svg-text theme-change light-theme">ApolloX</div>
                  </div>
                </div>
              </div>
            </div>
